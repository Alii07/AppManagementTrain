...
<form action="{{ route('formulaire.store') }}" method="POST" class="form3">
    @csrf
    <div class="barre">
    ...
    <button type="submit" class="bouton">Ajouter la parcelle :</button>

     </form>
     <a href="parcelle" class="bouton2"> Retour</a>
