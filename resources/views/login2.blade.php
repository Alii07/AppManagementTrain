...
<body class="forms">
    ...
    <nav>
    	<ul class="liste marge">
    		<li class="bout">
    			<div class="radius whi"><a href="\login" class='deco'>Agriculteur</a></div>
    		</li>
    		<li class="bout">
    			<div class="radius whi"><a href="\login2" class='deco'>Administrateur</a></div>
    		</li>
    	</ul>
    </nav>

    <form method="POST" action="{{ route('users.indexs') }}" class="form2">
        @csrf
        <div class="barre">
			<h2>CONNEXION</h2>
		</div>
